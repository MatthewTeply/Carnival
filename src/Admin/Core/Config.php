    ...
    protected function configTwig() {
        ...
        foreach($this->config->entities as $key => $entity) {
            ...
            $args['entities'][$key] = [
                ...
                'display' => $entity->nav_display ?? true,
        ...
        if(!$this->request->isAjax()) {
            $this->header = $this->view->load('admin/partials/header', $args);
            $this->nav    = $this->view->load('admin/partials/nav'   , $args);
            $this->footer = $this->view->load('admin/partials/footer', $args);
        }
    }
